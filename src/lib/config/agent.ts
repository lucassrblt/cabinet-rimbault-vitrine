export const AGENT = {
  ...
  instagram: "https://www.instagram.com/cabinet.rimbault",
  linkedin: "https://www.linkedin.com/in/sophie-rimbault-immobilier",
  googleBusinessUrl:
    "https://www.google.com/maps/place/Cabinet+Rimbault/@48.8566,2.3522",
  address: {
    line1: "14 rue du Marché",
    postalCode: "92100",
  ...
  transports: [
    { icon: "metro" as const, label: "Métro ligne 9 — station Marcel Sembat" },
    { icon: "bus" as const, label: "Bus 126, 175, 72" },
    { icon: "parking" as const, label: "Parking Mairie de Boulogne (200 m)" },
  ],
  stats: {
    years: 14,
    communesCount: 8,
  ...
  legal: {
    carteT: "Carte professionnelle T n° CPI 9201 2024 000 012 345",
    cci: "CCI Hauts-de-Seine",
    garant:
      "CEGC — Caisse d’Épargne, 16 rue de Wagram, 75017 Paris — garantie 110 000 €",
    mediator:
      "Médiateur de la consommation : CNPM Médiation, 27 avenue de la Libération, 42400 Saint-Chamond — www.cnpm-mediation-consommation.eu",
    siret: "SIRET 923 456 789 00012",
    rcs: "RCS Nanterre B 923 456 789",
  },
} as const;

export const AGENT_BIO_PARAGRAPHS: string[] = [
  "Je suis Sophie Rimbault, agent immobilier indépendant, installée à Boulogne-Billancourt depuis 2012. Après huit ans dans de grandes enseignes immobilières franciliennes, j’ai fondé le Cabinet Rimbault pour offrir un accompagnement plus humain, plus réactif et ancré dans la réalité du terrain.",
  ...
  "Je concentre volontairement mon activité sur un périmètre resserré — Boulogne-Billancourt, Issy-les-Moulineaux, Meudon, Sèvres et les communes limitrophes — pour maîtriser chaque rue, chaque copropriété, chaque évolution de prix. Cette connaissance fine du terrain me permet de vous conseiller avec honnêteté, qu’il s’agisse d’une estimation, d’une négociation ou d’un choix de quartier.",
  ...
  "En dehors du cabinet, je suis bénévole au sein d’une association de quartier à Boulogne. C’est la même logique qui m’anime : des liens durables, de la disponibilité, et le sens du service.",
];
